...
def discover_products():
    ...
    # 1. Discover subdirectories and loose files in a single pass using os.scandir for better performance
    loose_images = []
    try:
    ...
    # 2. Process loose files discovered in INPUT_DIR root
