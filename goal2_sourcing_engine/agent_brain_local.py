...
class LocalBrain:
    ...
    async def list_products(self):
        ...
        try:
            ...
            # Why: Using glob with os.path.getmtime creates N+1 system calls.
            # What: Use os.scandir() which caches file attributes to avoid N+1 stat calls.
            try:
                with os.scandir(output_dir) as scanner:
                    entries = [e for e in scanner if e.is_file() and e.name.endswith(".png")]
