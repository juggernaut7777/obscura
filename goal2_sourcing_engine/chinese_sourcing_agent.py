        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                for idx, img_url in enumerate(img_urls):
                    ...
                    try:
                        ...
                        if response and response.startswith("data:image"):
                            ...
                            # Optimization: Use asyncio.to_thread to prevent blocking event loop on file I/O
                            ...
                            await asyncio.to_thread(_write_image, file_path, img_data)
                ...
                if generate_contact_sheet:
                    ...
                    def _write_metadata_and_link(prod_dir, meta, link_url):



                        with open(os.path.join(prod_dir, "metadata.json"), "w", encoding="utf-8") as f:
                        ...
                        with open(os.path.join(prod_dir, "link.txt"), "w", encoding="utf-8") as f:
                    ...
                    await asyncio.to_thread(_write_metadata_and_link, product_dir, metadata, url)
