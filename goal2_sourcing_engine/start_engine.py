    ...
    while True:
        ...
        try:
            ...
            if choice == '1':
                ...
                subprocess.run([sys.executable, "_archive/login_scripts/login_socials.py"])
            elif choice == '2':
                print("\n[*] Launching Kling AI Login...")
                subprocess.run([sys.executable, "_archive/login_scripts/login_video.py"])
            elif choice == '3':
                ...
                subprocess.run([sys.executable, "mini_projects/factory_hunter.py"])
            elif choice == '6':
                ...
                print("\n[*] Pushing to VPS...")
                subprocess.run([sys.executable, "deploy_upgrades_to_vps.py"])
            elif choice == '8':
                print("\n[*] Running End-to-End Pipeline Test...")
                subprocess.run([sys.executable, "_archive/tests/pipeline_test_runner.py", "--self-heal"])
