    ...
    while True:
        ...
        try:
            ...
            if choice == '1':
                ...
                print("\n[*] Pushing to VPS...")
                # Note: push_to_vps.bat is a batch script. Keeping os.system or running with shell=True is needed for .bat
                # We switch to subprocess.run for consistency
                subprocess.run(["push_to_vps.bat"], shell=True)
            elif choice == '8':
                ...
                # Prevent Command Injection by using list of arguments with subprocess.run
