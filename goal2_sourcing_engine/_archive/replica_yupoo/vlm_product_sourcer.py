...
def cleanup_old_reviews(max_age_days: int = 3):
    ...
    urls_to_preserve = []
    try:
        # Optimization: Use os.scandir instead of os.listdir to avoid N+1
        # system call bottlenecks by utilizing cached stat calls for file modification times.
        ...
        safe_print(f"  [!] Error accessing {REVIEW_PENDING_DIR}: {e}")
