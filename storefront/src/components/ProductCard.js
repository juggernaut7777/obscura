...
// Use React.memo to prevent unnecessary O(N) re-renders when global context state (like CartContext)
// changes in parent page layouts, which was causing performance bottlenecks.
